# M2-ALIGN-001 — Canonical alignment

## Goal
Tạo timeline và exact joins theo period end.
...
- contracts/TimeAligner.md

## Dependencies
-

## Allowed Files
- `src/dao_vang/data/alignment/canonical.py`
- `tests/unit/data/alignment/test_canonical.py`
