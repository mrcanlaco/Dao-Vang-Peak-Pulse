# M4-FEATURESET-001 — Feature table builder

## Goal
Build versioned feature artifact.
...
- 05_AI/AGENTS.md
- contracts/FeatureEngine.md
- 03_Research/FEATURE_SPEC.md

## Dependencies
-

## Allowed Files
- `src/dao_vang/features/builder.py`
- `tests/integration/test_feature_builder.py`
