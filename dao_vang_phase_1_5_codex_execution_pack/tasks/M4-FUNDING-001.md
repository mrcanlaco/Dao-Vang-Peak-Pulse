# M4-FUNDING-001 — Funding features

## Goal
Implement funding feature v0.1.
...
## Allowed Files
- `src/dao_vang/features/funding.py`
- `tests/unit/features/test_funding.py`
- `tests/leakage/test_funding_features.py`
