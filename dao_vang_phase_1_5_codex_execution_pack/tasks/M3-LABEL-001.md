# M3-LABEL-001 — Distribution label engine

## Goal
Implement Label v0.1 đúng thuật toán.
...
- contracts/LabelEngine.md

## Dependencies
-

## Allowed Files
- `src/dao_vang/labels/distribution.py`
- `tests/unit/labels/test_distribution.py`
