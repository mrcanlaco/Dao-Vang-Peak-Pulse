# M1-OI-001 — OI collector

## Goal
Implement open interest statistics collector.
...
## Allowed Files
- `src/dao_vang/data/collectors/open_interest.py`
- `tests/unit/data/collectors/test_open_interest.py`
