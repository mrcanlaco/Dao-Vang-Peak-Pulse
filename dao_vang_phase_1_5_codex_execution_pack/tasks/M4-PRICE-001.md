# M4-PRICE-001 — Price features

## Goal
Implement price feature v0.1 past-only.
...
## Allowed Files
- `src/dao_vang/features/price.py`
- `tests/unit/features/test_price.py`
- `tests/leakage/test_price_features.py`
