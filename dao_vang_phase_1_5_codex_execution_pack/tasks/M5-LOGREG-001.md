# M5-LOGREG-001 — Logistic baseline

## Goal
Train-only preprocessing và logistic regression.
...
- 05_AI/AGENTS.md
- 03_Research/BASELINE.md
- 03_Research/LEAKAGE.md

## Dependencies
-

## Allowed Files
- `src/dao_vang/baselines/logistic.py`
- `tests/unit/baselines/test_logistic.py`
- `tests/leakage/test_train_only_fit.py`
