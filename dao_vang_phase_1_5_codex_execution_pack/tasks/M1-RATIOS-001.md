# M1-RATIOS-001 — Ratio collectors

## Goal
Implement global và top trader account ratio collectors.
...
## Allowed Files
- `src/dao_vang/data/collectors/ratios.py`
- `tests/unit/data/collectors/test_ratios.py`
