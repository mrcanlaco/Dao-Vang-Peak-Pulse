# M5-METRICS-001 — Metrics

## Goal
Implement row/event metrics và cooldown.
...
- 05_AI/AGENTS.md
- 01_Product/SUCCESS_METRICS.md
- 03_Research/VALIDATION.md

## Dependencies
-

## Allowed Files
- `src/dao_vang/validation/metrics.py`
- `tests/unit/validation/test_metrics.py`
