# M1-KLINES-001 — Klines collector

## Goal
Implement pagination và raw persistence cho klines đóng.
...
## Allowed Files
- `src/dao_vang/data/collectors/klines.py`
- `tests/unit/data/collectors/test_klines.py`
