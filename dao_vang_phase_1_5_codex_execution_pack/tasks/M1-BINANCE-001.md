# M1-BINANCE-001 — Binance HTTP client

## Goal
Xây public USD-M client với timeout, retry, rate-limit metadata.
...
- 02_Data/COLLECTION_POLICY.md

## Dependencies
-

## Allowed Files
- `src/dao_vang/data/collectors/binance_client.py`
- `tests/unit/data/collectors/test_binance_client.py`
