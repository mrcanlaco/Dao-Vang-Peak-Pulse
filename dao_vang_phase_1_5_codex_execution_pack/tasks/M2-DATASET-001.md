# M2-DATASET-001 — Dataset builder

## Goal
Build aligned dataset, watermark và fingerprint.
...
- 05_AI/AGENTS.md
- 02_Data/DATA_PIPELINE.md
- 02_Data/DATA_VERSIONING.md

## Dependencies
-

## Allowed Files
- `src/dao_vang/data/dataset.py`
- `tests/integration/test_dataset_builder.py`
