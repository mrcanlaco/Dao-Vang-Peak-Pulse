# M6-ARTIFACT-001 — Artifact registry

## Goal
Persist provenance và immutable artifacts.
...
## Allowed Files
- `src/dao_vang/experiments/artifacts.py`
- `tests/unit/experiments/test_artifacts.py`
