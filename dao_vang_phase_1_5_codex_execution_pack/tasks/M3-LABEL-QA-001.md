# M3-LABEL-QA-001 — Label diagnostics

## Goal
Báo prevalence, exclusions, lead time và ambiguity.
...
## Allowed Files
- `src/dao_vang/labels/diagnostics.py`
- `tests/unit/labels/test_diagnostics.py`
