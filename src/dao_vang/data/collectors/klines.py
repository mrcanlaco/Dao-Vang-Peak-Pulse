...
class KlinesCollector:
    ...
    def collect(
        ...
        """Collect klines data from Binance and store it as raw JSONL envelopes."""
        ...
        try:
            while current_start_ms <= end_ms:
                ...
                data_list = cast(list[list[Any]], data)
                ...
                envelope = {
                    ...
                    "source_version": f"B_USDM_klines_v1_{self.collector_version}",
                    "collector_version": self.collector_version,
            ...
            if envelopes:
                dt = start_time.date()
                raw_path_dir = get_raw_path(self.settings.paths.data_dir, "klines", dt)
            ...
            logger.error("klines_collection_failed", error=str(e))
