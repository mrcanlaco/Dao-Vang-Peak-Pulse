...
class BaseRatioCollector:
    endpoint = ""
    data_type = ""
    source_version_prefix = ""
    ...
    def collect(
        ...
        try:
            ...
            logger.error("ratio_collection_failed", error=str(e))
...
class GlobalRatioCollector(BaseRatioCollector):
    endpoint = "/futures/data/globalLongShortAccountRatio"
    data_type = "global_ratio"
    source_version_prefix = "B_USDM_global_ratio_v1"


class TopRatioCollector(BaseRatioCollector):
    endpoint = "/futures/data/topLongShortAccountRatio"
    data_type = "top_ratio"
    source_version_prefix = "B_USDM_top_ratio_v1"
