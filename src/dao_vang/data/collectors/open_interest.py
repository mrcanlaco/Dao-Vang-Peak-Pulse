...
class OpenInterestCollector:
    ...
    def collect(
        ...
        """Collect open interest history from Binance and store as JSONL."""
        ...
        try:
            while current_start_ms <= end_ms:
                ...
                data = self.client.get("/futures/data/openInterestHist", params)
                ...
                envelope = {
                    ...
                    "source_version": f"B_USDM_oi_v1_{self.collector_version}",
                    "collector_version": self.collector_version,
            ...
            if envelopes:
                ...
                raw_path_dir = get_raw_path(
                    self.settings.paths.data_dir, "open_interest", dt
                )
            ...
            logger.error("oi_collection_failed", error=str(e))
