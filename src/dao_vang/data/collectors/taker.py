...
class TakerRatioCollector:
    ...
    def collect(
        ...
        """Collect taker buy/sell ratio history from Binance and store as JSONL."""
        ...
        try:
            while current_start_ms <= end_ms:
                ...
                req_at = system_now()
                data = self.client.get("/futures/data/takerlongshortRatio", params)
                rec_at = system_now()
                ...
                envelope = {
                    ...
                    "source_version": f"B_USDM_taker_v1_{self.collector_version}",
                    "collector_version": self.collector_version,
            ...
            if envelopes:
                ...
                raw_path_dir = get_raw_path(
                    self.settings.paths.data_dir, "taker_ratio", dt
                )
            ...
            logger.error("taker_collection_failed", error=str(e))
