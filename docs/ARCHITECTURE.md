...
| [`data/`](file:///d:/Coding/dao_vang/src/dao_vang/data) | Ingestion clients (Binance USD-M, CoinGecko), schemas, data quality validation, and DuckDB storage. | `BinanceClient`, `KlinesCollector`, `DuckDBStorage` |
