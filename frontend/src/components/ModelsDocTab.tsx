...
- **V3.1 Sniper Target (Regime + LightGBM):** Đạt **36.6% precision** (gấp **2.75 lần** Heuristic, vượt trội trên mọi chu kỳ kiểm định).
              ...
              <div className="space-y-4 text-[11px]">
                ...
                <div className="bg-slate-950 p-3 rounded border border-slate-800/50">
                  ...
                  <ul className="list-disc pl-4 space-y-1 text-slate-300">
                    ...
                    <li><span className="text-rose-300">Giới hạn 15 alerts/ngày</span> Ép giới hạn tỷ lệ hú còi để tối đa hóa độ chính xác (36.6%).</li>
                  </ul>
                </div>
