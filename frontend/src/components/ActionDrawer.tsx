    ...
    <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-3.5 flex flex-col h-full overflow-y-auto space-y-3.5">
      ...
      <div className="border-b border-slate-800 pb-2.5 flex items-start justify-between gap-2">
        <div>
          <h2 className="text-xs font-bold text-slate-100 uppercase tracking-wider flex items-center gap-1.5">
            ...
            QUYẾT ĐỊNH & TỰ ĐỘNG HÓA THÔNG MINH
          </h2>
          <p className="text-[11px] text-slate-400">Trung tâm phát cảnh báo & Cấu hình tự động</p>
        </div>
        {onCloseDrawer && (
          <button
      ...
      <div className="bg-slate-950/90 border border-slate-800 rounded-xl p-3 space-y-2.5">
        ...
        {selectedSignal ? (
          ...
          <div className="text-xs text-slate-500 italic p-2 text-center">
            Vui lòng chọn 1 tín hiệu để bắn cảnh báo
          </div>
        )}

        <div>
          <label className="text-[10px] text-slate-400 font-medium">Kênh nhận:</label>
          <input
            type="text"
      ...
      <div className="bg-slate-950/90 border border-slate-800 rounded-xl p-3 space-y-2.5 text-xs">
        <div className="font-bold text-amber-400 flex items-center gap-1.5">
          ...
          QUY TẮC TỰ ĐỘNG HÓA THÔNG MINH
        </div>

        {/* Auto Telegram Toggle */}
        <div className="flex items-center justify-between bg-slate-900 p-2 rounded border border-slate-800">
          <div>
            <div className="font-medium text-slate-200 text-[11px]">Tự động bắn Telegram</div>
            <div className="text-[10px] text-slate-400">Khi điểm rủi ro ≥ 80%</div>
          </div>
          <input
            type="checkbox"
        ...
        <div className="flex items-center justify-between bg-slate-900 p-2 rounded border border-slate-800">
          <div className="flex items-center gap-1.5 text-slate-200">
            ...
            <span className="text-[11px]">Âm thanh còi báo xả</span>
          </div>
          <input
            type="checkbox"
        ...
        <div>
          <label className="text-[10px] text-slate-400 font-medium flex items-center gap-1">
            <Globe className="w-3 h-3 text-sky-400" /> URL Webhook (bot tự động):
          </label>
          <input
            type="text"
      ...
      <div className="p-2.5 bg-amber-950/20 border border-amber-500/20 rounded-xl text-[11px] space-y-1 text-slate-400">
        <div className="font-bold text-amber-400 flex items-center gap-1">
          <Sparkles className="w-3 h-3" /> ĐẶC TẢ BỘ MÁY V1.5
        </div>
        <div>Khung dự báo: <span className="text-slate-200 font-mono">24 giờ</span></div>
        <div>Mục tiêu giảm: <span className="text-slate-200 font-mono">≥ 8.0%</span></div>
        <div>Mức lệch tối đa: <span className="text-slate-200 font-mono">≤ 4.0%</span></div>
      </div>
