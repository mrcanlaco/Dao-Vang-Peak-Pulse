...
> 📎 Текущая production-модель, SHA-256 и границы доказательств зафиксированы в [описании production-модели](docs/PRODUCTION_MODEL.md).
...
- 🤖 **Машинное обучение и демон самообучения (Self-Learning Daemon):**
  - Поддерживает калиброванных challenger-моделей в shadow-режиме; автоматического продвижения нет.
  - Использует **Walk-Forward Validation** и регрессионные проверки для снижения риска lookahead.
...
flowchart LR
    ...
    F -->|Serving contract и frozen threshold пройдены| G[Telegram Бот Оповещений]
...
2. **Нормализация и As-of Join:** Point-in-Time синхронизация и регрессионные проверки против lookahead.
